...
Estes quatro PNGs foram copiados sem alterações dos recursos locais da **Caesaria** em `/root/caesaria-game-inspect/resources`. São usados apenas para validar a renderização da Fase 1; não são assets próprios do AICaesar.
...
Total: 4 PNGs, 82 084 bytes. Todos são carregados e renderizados. Os ficheiros permanecem inalterados; a escala é aplicada no renderer.
