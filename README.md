...
**Fase 32 — cenário de planeamento**: mapa isométrico 30×30, construção e demolição manual de roads/houses/wells/farms/granaries/markets e amenities garden/plaza/fountain, navegação desktop e touch com pan/pinch, preview efémero do tile livre/ocupado com custo, tesouro após compra, benefício imediato e risco persistente derivados sem mutar a cidade, quatro cenários determinísticos com perfis Easy/Normal, incluindo **Mercado na encruzilhada**, onde a localização do mesmo mercado decide a cobertura de comida, o custo de recuperação e a falta de trabalhadores, rede principal e serviços por distância BFS em estradas, desirability local determinística, população, workers, finanças, eventos temporários determinísticos, pedidos do imperador, advisor mock local estratégico com planos multi-ação, after-action promise-vs-result, métricas locais de sessão, overlays de água/comida/rede viária/desirability e save/load local v1.
...
- O painel **Scenario setup** permite iniciar **Found a functioning settlement**, **Establish a merchant quarter**, **Mercado na encruzilhada** ou **Keep a resilient province** em **Easy** ou **Normal**. Cada seleção cria um seed gratuito e determinístico; **Mercado na encruzilhada** começa com casas, água, farm e granary, mas sem market: em Normal, o market em `(12, 14)` serve todas as casas por 50, enquanto o market em `(17, 14)` só serve metade e exige uma segunda construção para recuperar.
