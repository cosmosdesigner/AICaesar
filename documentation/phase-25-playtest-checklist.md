...
| 5 | Resilient Province / Easy | 40 roads, 10 casas cheias, 2 wells, farm, granary, market | 625 | 60, 53%, 38%, ≤50%, 113 | 225 / `< 0` |
| 6 | Resilient Province / Normal | 40 roads, 10 casas cheias, 2 wells, farm, granary, market | 425 | 80, 70%, 50%, ≤30%, 150 | 180 / `< 25` |

Os percentuais Easy são o arredondamento determinístico de 75% das metas `at-least`; a meta `at-most` de falta de workers recebe 20 pontos percentuais de tolerância. Easy adiciona 200 à tesouraria do seed, multiplica o limite por 1,25 (arredondado para cima) e usa limiar de derrota 0. Normal reproduz os valores base de cada cenário.
